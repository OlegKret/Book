...
namespace Book.Services
{
    public class BookRepository : IBookRepository
    {
        ...
        public bool CreateBook(List<int> authorsId, List<int> categoriesId, Models.Book book)
        {
        ...
        public bool DeleteBook(Models.Book book)
        {
            _bookDbContext.Remove(book);
            return Save();
        }

        public Models.Book GetBook(int bookId)
        {
            return _bookDbContext.Books.Where(b => b.Id == bookId).FirstOrDefault();
        }

        public Models.Book GetBook(string bookIsbn)
        {
        ...
        public ICollection<Models.Book> GetBooks()
        {
        ...
        public bool UpdateBook(List<int> authorsId, List<int> categoriesId, Models.Book book)
        {
            var authors = _bookDbContext.Authors.Where(a => authorsId.Contains(a.Id)).ToList();
            var categories = _bookDbContext.Categories.Where(c => categoriesId.Contains(c.Id)).ToList();
