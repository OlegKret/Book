...
namespace Book.Controllers
{
    ...
    public class AuthorsController : ControllerBase
    {
        ...
        public AuthorsController(IAuthorRepository authorRepository, IBookRepository bookRepository,
            ICountryReposotory countryReposotory)
        {
    ...
    [HttpPost]
        ...
        public IActionResult CreateAuthor([FromBody] Author authorToCreate)
        {
            ...
            if (!_countryReposotory.CountryExists(authorToCreate.Country.Id))
            {
                ModelState.AddModelError("", "Country doesn't exist!");
                return StatusCode(404, ModelState);
            }

            authorToCreate.Country = _countryReposotory.GetCountry(authorToCreate.Country.Id);
    ...
    [HttpPut("{authorId}")]
        ...
        public IActionResult UpdateAuthor(int authorId, [FromBody] Author authorToUpdate)
        {
            ...
            if (!_countryReposotory.CountryExists(authorToUpdate.Country.Id))
                ModelState.AddModelError("", "Country doesn't exist!");

            if (!ModelState.IsValid)
                return StatusCode(404, ModelState);

            authorToUpdate.Country = _countryReposotory.GetCountry(authorToUpdate.Country.Id);
